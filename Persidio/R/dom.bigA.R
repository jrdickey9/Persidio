#' dom.bigA
#'
#' @description dom.bigA, a function describing selection on a population given a single climate change event that affects temperature by a 2 degree threshold. Exploring with the geontypes AA, Aa, and aa. A allele has dominance (wAa=wAA). This function estimates population size.
#'
