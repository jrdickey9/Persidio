#' dom.lila
#'
#' @description dom.lila, a function describing selection on a population given a single climate change event that affects temperature by a 2 degree threshold. Exploring with the geontypes AA, Aa, and aa. The a allele has dominance (wAa=waa). This function estimates population size.
#'
#' @usage dom.lila(p,K,r,gens)
#'
