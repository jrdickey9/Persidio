#' ex.Rescue
#'
#' @description ex.Rescue, a function describing selection on a population given a single climate change event that affects temperature by a 2 degree threshold. Exploring with the geontypes AA, Aa, and aa. No allele has dominance and the population is in hardy weinberg equilibrium to denote genotype frequency. This function estimates population size.
#'
#' @usage ex.Rescue(p,K,r,gens)
#'
